...
def get_checkout_url(request):
    redirect_url = ''
    req = create_google_checkout_request(request)
    try:
        ...
        redirect_url = parse_google_checkout_response(response_xml)
    return redirect_url



def create_google_checkout_request(request):
    url = settings.GOOGLE_CHECKOUT_URL
    cart = build_xml_shopping_cart(request)
...
def parse_google_checkout_response(response_xml):
    redirect_url = ''
...
def build_xml_shopping_cart(request):
    doc = Document()
